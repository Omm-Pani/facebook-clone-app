import { create, menu } from "../../data/AllMenuData";
    ...
    <div className="all_menu">
      ...
      <div className="all_menu_wrap scrollbar">
        <div className="all_left">
          ...
          <div className="all_menu_group">
            <div className="all_menu_group_header">Proffesional</div>
            {menu.slice(16, 19).map((item, i) => (
              <AllMenuItem
                name={item.name}
                description={item.description}
                icon={item.icon}
