  ...
  return (
    <div className="create_comment_wrap">
      <div className="create_comment">
        <img src={user?.picture} alt="" className="create_comment_profilePic" />
        <div className="comment_input_wrap">
          {picker && (
            <div className="comment_emoji_picker emoji_move">
              <EmojiPicker
                height={400}
                width={350}
          ...
          <div className="comment_circle" style={{ marginTop: "5px" }}>
            <ClipLoader size={20} color="#187642" loading={loading} />
          </div>
          <div
